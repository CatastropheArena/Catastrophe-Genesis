 ...
 */
  ...
  * 最新检查点的时间戳(毫秒)
  */
 pub async fn get_latest_checkpoint_timestamp(client: SuiClient) -> SuiRpcResult<u64> {
  ...
  * 当前参考Gas价格
  */
 pub async fn get_reference_gas_price(client: SuiClient) -> SuiRpcResult<u64> {
     let rgp = client
         .read_api()
  ...
  * 调用者需注意可能的溢出风险
  */
 pub fn duration_since(offset: u64) -> i64 {
